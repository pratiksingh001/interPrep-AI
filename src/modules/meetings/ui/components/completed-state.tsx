    ...
    return (
        <div className="flex flex-col gap-y-4">
            <Tabs defaultValue="summary">
                <div className="bg-gray-900/50 border border-gray-800 rounded-xl px-3">
                    <ScrollArea>
                ...
                <TabsContent value="recording">
                    <div className="bg-gray-900/50 border border-gray-800 rounded-xl px-6 py-8">
                        <video 
                ...
                <TabsContent value="summary">
                    <div className="bg-gray-900/50 border border-gray-800 rounded-xl">
                        <div className="px-6 py-8 gap-y-6 flex flex-col">
                            ...
                            <div className="flex gap-x-3 items-center">
                                ...
                                <p className="text-gray-400">{data.startedAt ? format(data.startedAt, "PPP") : ""}</p>
                            </div>
                            ...
                            <div className="prose prose-invert max-w-none">
                                <Markdown
                                    components={{
                                        h1: (props) => (
                                            <h1 className="text-2xl font-medium mb-6 text-white" {...props} />
                                        ),
                                        h2: (props) => (
                                            <h2 className="text-xl font-medium mb-6 text-white" {...props} />
                                        ),
                                        h3: (props) => (
                                            <h3 className="text-lg font-medium mb-6 text-white" {...props} />
                                        ),
                                        h4: (props) => (
                                            <h4 className="text-base font-medium mb-6 text-white" {...props} />
                                        ),
                                        p: (props) => (
                                            <p className="mb-6 leading-relaxed text-gray-300" {...props} />
                                        ),
                                        ul: (props) => (
                                            <ul className="list-disc list-inside mb-6 text-gray-300" {...props} />
                                        ),
                                        ol: (props) => (
                                            <ol className="list-decimal list-inside mb-6 text-gray-300" {...props} />
                                        ),
                                        li: (props) => (
